...
$sql = "SELECT anggota.*,jual_detail.jumlah,jual_detail.harga_jual from anggota,jual,jual_detail where anggota.id_anggota=jual.id_anggota AND jual.id_jual=jual_detail.id_jual and (tanggal_transaksi BETWEEN '$tanggal_awal' and '$tanggal_akhir') AND jual_detail.id_produk=542 AND anggota.is_individual=0 GROUP BY anggota.nama";
...
while ($kolom = mysqli_fetch_array($query)) {
    ...
    <tr>      
      ...
      <th align="center" style="width:20%;">Tanggal Trx</th>
    ...
    $sql2 = "SELECT jual_detail.*,produk.nama,jual.id_anggota,jual.tanggal_transaksi from jual_detail,produk,jual where jual_detail.id_produk=produk.id_produk and jual_detail.id_jual=jual.id_jual and id_anggota='$id_anggota' and (tanggal_transaksi BETWEEN '$tanggal_awal' and '$tanggal_akhir') and jual_detail.id_produk=542";
