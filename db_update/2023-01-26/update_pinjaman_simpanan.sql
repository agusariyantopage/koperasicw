...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2023 pada 05.04
...
CREATE TABLE `pinjaman` (
  ...
  `status_pinjaman` enum('AKTIF','SUSPENDED','SELESAI','') NOT NULL DEFAULT 'AKTIF'
...
--
-- Dumping data untuk tabel `simpanan_jenis`
--

INSERT INTO `simpanan_jenis` (`id_simpanan_jenis`, `kode`, `jenis_simpanan`, `tempo_pembayaran`, `keterangan`, `link`) VALUES
(1, 'SIDIDIK', 'Simpanan Pendidikan', 'Bulanan', '-', 'simpanan-tambah'),
(2, 'TAHARA', 'Tabungan Hari Raya', 'Bulanan', '-', 'simpanan-tambah'),
(3, 'DEPOSITO', 'Deposito', 'Satu Kali Bayar', '-', 'simpanan-tambah-sw'),
(4, 'SW', 'Simpanan Wajib', 'Bebas', '-', 'simpanan-tambah-sw'),
(5, 'SS', 'Simpanan Suka Rela', 'Bebas', '-', 'simpanan-tambah-sw'),
(6, 'SP', 'Simpanan Penyertaan', 'Bebas', '-', 'simpanan-tambah-sw');
...
--
ALTER TABLE `simpanan_jenis`
  MODIFY `id_simpanan_jenis` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
